-- ========================================================
-- 🏆 MASTER STAFF MANAGEMENT SETUP
-- ========================================================
-- Run this in your Supabase SQL Editor to fix all issues:
-- 1. "Not Assigned" Room errors
-- 2. "Permission Denied" toggle errors
-- 3. "Foreign Key Violation (23503)" errors
-- ========================================================
...
BEGIN
  ...
  INSERT INTO public.profiles (id, email, full_name, role, assigned_room_id, is_active)
  VALUES (
    new.id, 
    new.email, 
